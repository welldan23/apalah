...
- Workspace ID: `fb0ad4c8-bb7c-408e-8208-b121191e2af0`
- An access token starting with `ngpk_`. Provide it via the `NGODINGPAKEAI_TOKEN`
  ...
  Create one at https://www.ngodingpakeai.com/settings (API keys). Synced content is viewable at https://www.ngodingpakeai.com/workspace/fb0ad4c8-bb7c-408e-8208-b121191e2af0.
...
2. `npx ngodingpakeai connect --workspace fb0ad4c8-bb7c-408e-8208-b121191e2af0 --token "$NGODINGPAKEAI_TOKEN"` — link this repo to the workspace (first time only).
...
5. Always report the sync summary and https://www.ngodingpakeai.com/workspace/fb0ad4c8-bb7c-408e-8208-b121191e2af0. Only pass on links the CLI actually printed — never assemble one from an id yourself.
